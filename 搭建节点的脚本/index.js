...
const UUID = process.env.UUID || '46bbba70-ab0c-4af4-9136-9b62fa56631f';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'data2.4.4.8.b.0.d.0.0.1.0.a.2.ip6.arpa';           // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYTBjN2ExMTEwZjIwZTgxMzMwYTAxN2VjOGQ5MjNmYzQiLCJ0IjoiMTZmZTg1Y2UtMzc2OC00NGM5LWFlOGMtZjEyN2YwNmE5NTUzIiwicyI6IlpUbGpaalE1TldFdFpUaG1NQzAwTWpnekxXSXdOamd0TWpCaE4ySmlaRGt5Tm1GbSJ9';               // argo固定隧道token或json,留空即使用临时隧道
